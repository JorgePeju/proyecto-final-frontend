            ...
            <div className="w-full h-full flex items-center justify-end">
                <div className="bg-teal-800 w-80 max-w-md h-full px-6 py-8">
                    ...
                    <form className="space-y-4" onSubmit={handleSubmit}>
                        ...
                        {error && <p>{error}</p>}
                        <button type="submit" className="w-full block bg-indigo-500 hover:bg-indigo-400 focus:bg-indigo-400 text-white font-semibold rounded-lg px-4 py-2">Regístrate</button>
                    </form>
                    ...
                    <p className="mt-8">¿Ya tienes cuenta?</p>
                        <button onClick={handleToggle} className="text-blue-500 hover:text-blue-700 font-semibold">Entra aquí con tue cuenta</button>
