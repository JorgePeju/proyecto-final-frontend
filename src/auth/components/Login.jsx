            ...
            <section className="flex flex-col md:flex-row h-screen items-center">
                ...
                <div className="bg-white w-full md:max-w-md lg:max-w-full md:mx-auto md:w-1/2 xl:w-1/3 h-screen px-6 lg:px-16 xl:px-12
                    ...
                    <div className="w-full h-100">
                        ...
                        <h1 className="text-xl md:text-2xl font-bold leading-tight mt-12">Entra con tu cuenta</h1>
                        ...
                        <form className="mt-6" onSubmit={handleSubmit}>
                            ...
                            <div className="mt-4">
                                ...
                                <input type="password" name="password" id="password" placeholder="Contraseña" className="w-full px-4 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-blue-500 focus:bg-white focus:outline-none" 
                                onChange={handleChange}/>
                            </div>
